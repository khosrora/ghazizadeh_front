...
import { getAddressUser } from '../../../../store/dashboard/DashboardSlice';
        ...
        <div className="flex flex-col gap-y-4 lg:mt-8">
            {
                address.length === 0 ?
                    ...
                    :
                    <div className="bg-[#FFFFFF] w-full rounded-xl p-4 space-y-4">
                        <div className="flex justify-between items-center">
                            <div className="form-control">
                                <label className="label cursor-pointer">
                                    <input type="radio" name="radio-10" className="radio checked:bg-red-500" />
                                    <span className="label-text mr-4">نام و نام خانوادگی : حسین میرسالم</span>
                                </label>
                            </div>
                            <div className="">
                        ...
                        <div className="">
                            <p>آدرس :
                                <span className='mr-2 text-xs'>
                                    زاهدان زیباشهر خیابان پیروزی بین پیروزی 7 و9
                                </span>
                            </p>
                        </div>
                        <hr />
