...
const IndexPage = () => {
    return (
        <div className="flex flex-col justify-center items-center  p-2 lg:mt-8 md:flex-row-reverse md:justify-between md:items-center">
            <div className="">
                <Image
            ...
            <div className="mt-6 px-4 flex flex-col justify-center items-center w-full md:items-start md:w-1/2">
                <div className="flex flex-col">
                    ...
                    <p className="mt-2 text-[16px] leading-9 lg:text-[24px]">
                        انواع لوازم یدکی با کیفیت و لوازم تزئینی خفن رو به راحتی <br /> جست و جو و خرید کن
                    </p>
                </div>
                <div className="bg-red-600 w-full h-[48px] rounded-full p-2 overflow-hidden relative mt-4">
                    <input
                        type="text"
